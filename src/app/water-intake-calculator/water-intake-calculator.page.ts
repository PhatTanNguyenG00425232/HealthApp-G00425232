...
@Component({
  ...
  standalone: true,
  imports: [IonContent,IonInput, IonHeader, IonTitle,IonSelect, IonToolbar, CommonModule, FormsModule,IonButton,IonBackButton,IonItem,IonSelectOption,IonLabel],
})
